    ...
    return(
        ...
        <div className="absolute top-[68px] left-[422px] flex flex-col items-center justify-start gap-[64px] text-13xl text-black font-heading-heading-3">
          <div className="flex flex-col items-center justify-start gap-[24px]">
            ...
            <div className="relative text-xs font-text-20-bold text-center [color:linear-gradient(90deg,_#4776e6,_#8e54e9)] inline-block w-[596px]">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#4776e6] to-[#8e54e9]">
